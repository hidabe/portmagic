<?php require_once("layout/bootstrap/common/head.php"); ?>
    ...
    <div id="wrap">
      ...
      <div class="container">
        ...
        <p class="lead">Portfolio de trabajos en los que hemos trabajado.</p>
    ...
    <div id="footer">
      <div class="container">
        <p class="muted credit">PortMagic Powered <a href="http://martinbean.co.uk">Martin Bean</a> and <a href="http://ryanfait.com/sticky-footer/">Ryan Fait</a>.</p>
      </div>
    </div>
